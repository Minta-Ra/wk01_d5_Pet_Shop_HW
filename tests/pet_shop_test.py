...
class TestPetShop(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Dictionary to represent a pet shop
        self.cc_pet_shop = {
            "pets": [
                {
                    "name": "Sir Percy",
    ...
    # * get_pet_shop_name - inside of this function we pass pet shop and it will return a variable
    # * If function does not return that means it needs to do something else
    def test_pet_shop_name(self):
        name = get_pet_shop_name(self.cc_pet_shop)
        # * I need to get a name back "Camelot of Pets"
        self.assertEqual("Camelot of Pets", name)

    # * Go to admin to find total cash
